...
export default class ProductDetail extends Component {
  ...
  getData() {
    axios.get(`http://ecomlaravel.test/api/productDetail/${this.state.id}`).then((response) => {
  ...
  render() {
    ...
    var myview = productDetail.map((product, i) => {
      return (
<div className="col-lg-10 border p-3 main-section bg-white">
          <div className="row m-0">
            <div className="col-md-5 left-side-product-box pb-3">
              <img src="" className="border p-3" alt='' />
              <span className="sub-img">
                <img src={product.image} className="border p-2" alt='' />
                <img src={product.image} className="border p-2" alt='' />
                <img src="https://salt.tikicdn.com/cache/100x100/ts/product/91/6a/59/699d0859c5ce5c33909d7337e96a8025.jpg.webp" className="border p-2" alt='' />
                <img src="https://salt.tikicdn.com/cache/100x100/ts/product/7f/b3/09/9929ffa5d12b70e18fa077a727fd3c7e.jpg.webp" className="border p-2" alt='' />
              </span>
            </div>
            <div className="col-md-7">
              <div className="right-side-pro-detail border p-3 m-0">
                <div className="row">
                  ...
                  <div className="col-lg-12">
                    <p className="m-0 p-0 price-pro">{product.sale_price} <del>{product.price}</del></p>
                    <hr className="p-0 m-0" />
                  </div>
                  <div className="col-lg-12 pt-2">{product.brand}<br />{product.product_code}<br /></div>
